        ...
        <v-col cols="3">
          ...
          <div class="text-center pa-4">
            ...
            <v-dialog v-model="dialog" width="auto">
              <v-card width="700px" prepend-icon="mdi-swap-horizontal" title="Exchange Rate:">
                <v-card-text>
                ...
                <template v-slot:actions>
                  <v-btn class="px-6 mb-1 mr-3" text="Close" elevation="2" rounded @click="dialog = false"></v-btn>
                </template>
              </v-card>
            </v-dialog>
          </div>
